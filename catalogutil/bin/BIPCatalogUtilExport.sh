...
BIP_UTIL_JARS="biputil.jar aolj.jar commons-logging.jar orai18n-mapping.jar i18nAPI_v3.jar orai18n.jar jaxrpc.jar xdo-core.jar mail.jar xdo-server.jar xmlparserv2.jar commons-discovery.jar orai18n-collation.jar versioninfo.jar xdoparser11g.jar jaxrpc-api-1-1.jar axis_bip.jar commons-logging-1-0-4.jar orawsdl-api.jar activation.jar xmlparserv2.jar orai18n-mapping.jar ojdbc6.jar"
...
cp ./../../Export/"SAS Collection Dashboard Rep.xdo.catalog" ./../target/"SAS Collection Dashboard Rep.xdo.catalog"